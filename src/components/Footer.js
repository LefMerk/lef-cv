...
export default function Footer() {
    return (
        <footer className="aspect-[10/1] font-medium animate__animated animate__fadeInUp bg-[url('../assets/footer_bg.svg')] bg-cover bg-bottom bg-no-repeat">
            <div className="max-w-6xl h-full mx-auto text-white text-sm">
                {/* <div className="h-0.5 w-full bg-gray-700 md:mb-5"></div> */}
                <div className="flex flex-col-reverse h-full space-y-4 md:space-y-1 md:flex-row justify-between items-center gap-3 px-4 pb-5">
